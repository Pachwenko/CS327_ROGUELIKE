...
void generate(struct material **dungeon, struct room rooms[MAXROOMS], struct stair stairs[NUMSTAIRS]);
...
int main (int argc, char* argv[]) {
    ...
    if (save(filepath, dungeon, rooms, stairs)) {
        return -1;
    }
